...
### 📧 4. Correo y Notificaciones
El sistema está configurado para enviar notificaciones automáticas (registro, recuperación de contraseña, alertas de seguridad) utilizando un proveedor externo (por defecto **Gmail**) para garantizar la entrega y evitar bloqueos por spam.

#### 🔗 Configuración de Envío (Recomendado: Gmail)
Para que la plataforma envíe correos reales, debes configurar tus credenciales en el archivo `.env`:
